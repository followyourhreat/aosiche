<template>
  <div class="chart_line_wrap">
    ...
    <!--<div style="display: none">--> <div>
      <div style="width: 10px;height: 10px;background: #7099C1;border-radius: 10px;margin-left: 20px;float: left;margin-top: 2px"></div>
      <span style="font-size: 12px;margin-left: 20px;float: left">{{year}}年&nbsp{{month}}</span>
      <div style="width: 16px;height: 16px;line-height:14px;text-align:center;border: 1px solid #616260;float: right;margin-left: 20px;margin-right: 20px;border-radius: 16px;cursor: pointer" @click="aoright"> ></div>
      <div style="width: 16px;height: 16px;line-height:14px;text-align:center;border: 1px solid #616260;float: right;margin-left: 20px;border-radius: 16px;cursor: pointer" @click="aoleft"><</div>
    </div>
...
//        }
      ...
      aoleft(){
//        this.aoyear--
        this.$emit('yearleft',  this.year)
      },
      aoright(){
//        var years=dates.getFullYear();
//        if(this.aoyear>=years){
//
//        }else{
//          this.aoyear++
//        }
        this.$emit('yearright',  this.year)
